...
from states import VideoStorage, StorageGFoldersLink
from keyboards import start_kb, back_kb, pay_kb
from functions import summary, delete_videos, get_g_drive_folder
from loader import bot, dp

# Get a folders
@dp.message_handler(text="merge folders", state=None)
async def folders(message: types.Message):
    ...
    await StorageGFoldersLink.links.set()

# Google drive folders processing
@dp.message_handler(state=[StorageGFoldersLink.links, VideoStorage])
